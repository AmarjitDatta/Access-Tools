...
public class LoadOldMeasurement extends Activity {
    ...
    private void showOldResultInTextFields() {
        ...
        soundLevel = bundle.getDouble(ListSavedMeasurementsActivity.EXTRA_MESSAGE_SOUND_LEVEL);
        timeStamp = mLoadOldMeasurementActivityIntent.getStringExtra(ListSavedMeasurementsActivity.EXTRA_MESSAGE_TIMESTAMP);
        Log.d("Load old measurements", "Sound Level " + soundLevel);
        ...
        oldMeasurementValue.setText("Sound Level: " + soundLevel + "db");
    }
    ...
    private void setShareIntent() {
        if (mShareActionProvider != null) {
            ...
            String shareMessage = String.format("Sound level of the room is %sdb at %s time",soundLevel,timeStamp);
